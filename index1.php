    ...
    <body>
        ...
        <nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
            ...
            <div class="w3-container">
                <h3 class="w3-padding-64"><b>Shopify</b></h3>
            </div>
        ...
        <div class="w3-main" style="margin-left:340px;margin-right:40px">
            ...
            <div class="w3-row-padding">
                <div class="w3-half">
                    <img src="images/menwear1.jpg" style="width:40%" onclick="onClick(this)" alt="Polo Shirt">
                    <img src="images/menware-2.jpg" style="width:40%" onclick="onClick(this)" alt="IndoWestern">
                    <img src="images/menwear-3.jpg" style="width:40%" onclick="onClick(this)" alt="Safari Suits">
                </div>

                <div class="w3-half">
                    <img src="images/traditional.jpg" style="width:40%" onclick="onClick(this)" alt="Best Lehanga's">
                    <img src="images/frock.jpg" style="width:40%" onclick="onClick(this)" alt="Trendy Frocks">
                    <img src="images/frock1.jpeg" style="width:40%" onclick="onClick(this)" alt="Scandinavian design">
                </div>
            </div>
        ...
        <div class="w3-light-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px;"><p class="w3-center">Hurry Up!!! Best offers available.</p></div>
