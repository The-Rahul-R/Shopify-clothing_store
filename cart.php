...
<div class="container">
  <div class="navbar">
    <div class="logo">
        <a href="index.html"><img src="./images/shopify logo.jpg" alt="SHOPIFY" width="125px" /></a>
    </div>
    <nav>
      <ul id="MenuItems">
    ...
    <a><img src="https://i.ibb.co/PNjjx3y/cart.png" alt="" width="30px" height="30px" /></a>
...
<a href="cart.php?action=order" style="padding-left: 300px"><button class="w3-btn w3-pale-green"><span class="fa-thumbs-up fa fa-2x"></span> Buy Now</button></a>    
<a href="order confirmed.html" style="padding-left: 10px"><button class="w3-btn w3-pale-green"><span class="fa-credit-card fa fa-2x"></span> Checkout</button></a>        
...
{
   echo '<script>alert("Please Checkout to complete the procedure")</script>';
   echo '<script>window.location="cart.php"</script>'; 
    $gtotal = 0;
foreach($_SESSION["cart"] as $keys => $values)
{
    ...
    $gtotal = $gtotal + $price;
     ...
     $query = "INSERT INTO ORDERS ( name, price,  quantity, date) 
              VALUES ('" . $productname . "','" . $price . "','" . $quantity . "','" . $order_date . "')";
